...
import { StyleSheet, View, TextInput, Alert, Button, Text, useColorScheme } from 'react-native';
...
export default function App() {
  ...
  return (
    <View style={[styles.container, dynamicStyles.container]}>
      <Text style={[styles.keys, dynamicStyles.keys]}>Available Keys: {keys.join(', ')}</Text>
